...
This is an integration tutorial on how to integrate information from a Knowledge Base into a Workflow.
...
### I. Create or edit a content generation Workflow
...
- **Use Brand Kit** to get the information about your brand's competitors, customer profile, as well as the tone of voice and writing style for later steps
- **Prompt LLM** or **Perplexity Search** to research the most popular expense management products from competitors, your potential customers' pain points, or any other information that can give your text substance and relevance
...
1. In the Workflow Editor, click the *+* icon directly before the **Generate Article** action, search for a **Use Knowledge Base** action, and click on it to add it to the flow.
...
Use the "Receipt Scanning Public Info" variable to access it in the input fields of the **Generate Article** step by selecting a field and clicking the **(x) Add variable** icon.
...
After incorporating the approved Receipt Scanning feature writeup into your blog post, you have a comprehensive, quality listicle that includes only relevant and correct information.
...
- **Test your queries**: Use the [Knowledge Base Search Test](./getting-started/manage.md#searching-your-knowledge-base) feature to refine queries before adding them to Workflows

## Next steps

Now that you understand how to integrate Knowledge Bases into Workflows, the next thing to do is try it out:

- Head to the **Workflows** section in the left side menu of your Profound dashboard and have a go at putting together a simple flow with the Use Knowledge Base step
